...
def main():
    ...
    savings_maturity = float(input('What is the length of months for the savings account? '))
    ...
    print(f'Interest earned on your savings account: ${sav_interest_earned:,.2f}')
    ...
    cd_maturity = float(input('What is the length of months for the cd account? '))

    # Call the create_cd_account function and pass the variables from the user.
    updated_cd_balance, cd_interest_earned = create_cd_account(cd_balance, cd_interest, cd_maturity)

    # Print out the interest earned and updated CD account balance with interest earned for the given months.
    print(f'Interest earned on your CD Account: ${cd_interest_earned:,.2f}')
